...
TEST(url_builder_connect_longPolling, url_correct_if_query_string_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_connect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
            _XPLATSTR("connection token"), _XPLATSTR(""), _XPLATSTR("")));
}
...
TEST(url_builder_connect_longPolling, url_correct_if_query_string_not_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_connect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
            _XPLATSTR("connection-token"), _XPLATSTR(""), _XPLATSTR("q1=1&q2=2")));
...
TEST(url_builder_reconnect_longPolling, url_correct_if_query_string_empty)
{
    ASSERT_EQ(
        ...
        _XPLATSTR("connection token"), _XPLATSTR(""), _XPLATSTR(""), _XPLATSTR(""), _XPLATSTR("")));
}
...
TEST(url_builder_reconnect_longPolling, url_correct_if_query_string_not_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_reconnect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
        _XPLATSTR("connection-token"), _XPLATSTR(""), _XPLATSTR(""), _XPLATSTR(""), _XPLATSTR("q1=1&q2=2")));
...
TEST(url_builder_reconnect, url_correct_if_connection_data_not_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_reconnect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
        _XPLATSTR("connection token"), _XPLATSTR("[{\"Name\":\"ChatHub\"}]"), _XPLATSTR(""), _XPLATSTR(""), _XPLATSTR("")));
...
TEST(url_builder_reconnect, url_correct_if_last_message_id_not_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_reconnect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
        _XPLATSTR("connection token"), _XPLATSTR("[{\"Name\":\"ChatHub\"}]"), _XPLATSTR("L45T M355463_1D"), _XPLATSTR(""), _XPLATSTR("")));
...
TEST(url_builder_reconnect, url_correct_if_groups_token_not_empty)
{
    ASSERT_EQ(
        ...
        url_builder::build_reconnect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
        _XPLATSTR("connection token"), _XPLATSTR("[{\"Name\":\"ChatHub\"}]"), _XPLATSTR(""), _XPLATSTR("G 7"), _XPLATSTR("")));
...
TEST(url_builder_reconnect, query_string_added_after_message_id_and_groups_token)
{
    ASSERT_EQ(
        ...
        url_builder::build_reconnect(web::uri{ _XPLATSTR("http://fake/signalr/") }, transport_type::long_polling,
        _XPLATSTR("connection token"), _XPLATSTR("[{\"Name\":\"ChatHub\"}]"), _XPLATSTR("L45T_M355463_1D"), _XPLATSTR("G7"), _XPLATSTR("X")));
