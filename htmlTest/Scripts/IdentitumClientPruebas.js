...
$(document).ready(function () {
    ...
    $("#btnStart").click(function () {
        ...
        transaction.server.startCapture(users, $('#cboTransaction').find('option:selected').val());
...
function loadHub() {
    ...
    $.getScript("http://localhost:8087/signalr/hubs")
...
function connectHub() {
    ...
    $.connection.hub.start().done(function () {
		...
		//debugger;
		users = [
            { "UserAlias": "w", "Rol": "Supervisor", "Action": 2 },
            { "UserAlias": "w", "Rol": "Usuario", "Action": 1 }
                ];
		 transaction.server.startCapture(users, 1);
